...
<style>
  ...
  #vamsam{
      display:block;
        background: url(image/vamsam.jpg);
        height: 700px; 
        max-width:100%;
  ...
  @media only screen and (max-width: 800px){
    #vamsam{
      background:url(image/vamsam_phn.jpg);
      height:auto ; 
      max-width:100%;
        background-repeat: no-repeat;
...
<body>
<!-- body -->
<!-- <img id='vamsam' alt="vamsam" style="height: 700px; width:100%"> -->
<header id="vamsam">
</header>
...
<br> <br><b></b> <b><label for="uname">Colour Variations:</label><br></b>
  ...
  <button type="button" class="btn btn-warning">Land Reserved</button>
  <button type="button" class="btn btn-danger">Land Register</button>
